...
const FINAL_QUESTIONS: Question[] = [
  ...
  {id:"final9",exam:"final",lecture:"Cell Wall Inhibitors",q:"Augmentin consists of clavulanic acid + amoxicillin. What is the main role of clavulanic acid?",options:["Enables amoxicillin to cross the blood-brain barrier","Protects amoxicillin from beta-lactamase destruction","Increases amoxicillin absorption from the GI tract","Prolongs the half-life of amoxicillin in plasma"],answer:1,explanation:"Clavulanic acid irreversibly inhibits bacterial beta-lactamase → protects amoxicillin from enzymatic hydrolysis → extends its spectrum to include beta-lactamase-producing organisms."},
  {id:"final10",exam:"final",lecture:"Cell Wall Inhibitors",q:"A patient had recurrent UTIs and acquired resistance to ciprofloxacin. What is the most likely mechanism?",options:["Mutation of topoisomerase I","Mutation of DNA gyrase","Production of an active efflux pump","Beta-lactamase production"],answer:1,explanation:"Fluoroquinolone resistance: primarily via mutations in DNA gyrase (topoisomerase II) reducing drug binding. Efflux pumps are a secondary mechanism. Beta-lactamase is unrelated to quinolone mechanism."},
  ...
  {id:"final14",exam:"final",lecture:"Protein Synthesis Inhibitors",q:"Which drug is most suitable to treat Chlamydia, Rickettsia, and Acne?",options:["Tetracycline","Azithromycin","Ampicillin","Ciprofloxacin"],answer:0,explanation:"Tetracyclines are broad-spectrum and cover all three: intracellular organisms (Rickettsia, Chlamydia) and acne (anti-inflammatory + anti-P. acnes). Azithromycin covers Chlamydia but not Rickettsia."},
  ...
  {id:"final16",exam:"final",lecture:"Protein Synthesis Inhibitors",q:"Which drug binds reversibly to the 50S ribosomal subunit and inhibits the peptidyl transferase reaction?",options:["Chloramphenicol","Linezolid","Clindamycin","Erythromycin"],answer:0,explanation:"Chloramphenicol specifically inhibits peptidyl transferase on the 50S subunit (bacteriostatic). Linezolid also targets 50S but prevents 70S initiation complex formation. Erythromycin inhibits translocation; clindamycin acts similarly."},
  {id:"final17",exam:"final",lecture:"Protein Synthesis Inhibitors",q:"A neonate is given chloramphenicol and develops gray baby syndrome. What increased the risk?",options:["Decreased hepatic glucuronyl transferase activity","Decreased renal excretion of the drug","Increased hepatic blood flow","Increased renal filtration rate"],answer:0,explanation:"Neonates have immature UGT (glucuronyl transferase) → cannot conjugate chloramphenicol → accumulation → gray baby syndrome: cardiovascular collapse, abdominal distension, ashen cyanosis."},
  ...
  {id:"final22",exam:"final",lecture:"Protein Synthesis Inhibitors",q:"The most appropriate drug to manage pseudomembranous colitis (C. difficile)?",options:["Metronidazole","Ampicillin","Clindamycin","Ciprofloxacin"],answer:0,explanation:"Oral metronidazole is first-line for C. difficile CDI. Vancomycin oral is an alternative. Clindamycin and broad-spectrum antibiotics (ampicillin, ciprofloxacin) can themselves cause CDI by disrupting normal flora."},
  ...
  {id:"final26",exam:"final",lecture:"Nucleic Acid Synthesis Inhibitors",q:"A 50-year-old man started an antibiotic for acute prostatitis 1 week ago and now presents with sharp left calf pain. Which drug likely caused this?",options:["Trimethoprim","Erythromycin","Co-trimoxazole","Levofloxacin"],answer:3,explanation:"Fluoroquinolones (especially levofloxacin) cause tendinitis and tendon rupture — risk increased in patients over 60 years, on corticosteroids, or with organ transplants. Levofloxacin is a key drug for prostatitis treatment."},
  {id:"final27",exam:"final",lecture:"Nucleic Acid Synthesis Inhibitors",q:"Which drugs may prolong QT interval and should not be used in patients predisposed to dysrhythmias?",options:["Ciprofloxacin","Moxifloxacin","Norfloxacin","Ofloxacin"],answer:1,explanation:"3rd and 4th generation fluoroquinolones (moxifloxacin, levofloxacin, gatifloxacin, sparfloxacin) significantly prolong the QT interval. Ciprofloxacin (2nd gen) has minimal QT effect. Moxifloxacin is contraindicated in patients on antiarrhythmics."},
  {id:"final28",exam:"final",lecture:"Nucleic Acid Synthesis Inhibitors",q:"A 21-year-old man with cutaneous anthrax is given ciprofloxacin. What should he avoid taking with it?",options:["Alcohol","Grapefruit juice","Antacids","High-fat meals"],answer:2,explanation:"Antacids (Al³⁺, Mg²⁺, Ca²⁺) form insoluble chelates with ciprofloxacin → absorption reduced by up to 90%. Must be taken 2 hours apart. Ciprofloxacin is the drug of choice for anthrax prophylaxis and treatment."},
  ...
  {id:"final31",exam:"final",lecture:"Antifungal Drugs",q:"Which antifungal drug inhibits squalene epoxidase?",options:["Terbinafine","Fluconazole","Amphotericin B","Caspofungin"],answer:0,explanation:"Terbinafine inhibits squalene epoxidase → squalene accumulation (toxic) + ergosterol depletion → cell death. Drug of choice for onychomycosis. Fluconazole = CYP14α-demethylase inhibitor; amphotericin B = ergosterol binding; caspofungin = glucan synthase inhibitor."},
  {id:"final32",exam:"final",lecture:"Antifungal Drugs",q:"What is the mechanism of action of flucytosine?",options:["Inhibits thymidylate synthase after intracellular conversion to 5-FU","Binds ergosterol forming pores in the fungal cell membrane","Inhibits fungal glucan synthase reducing cell wall synthesis","Inhibits CYP14α-demethylase blocking ergosterol synthesis"],answer:0,explanation:"Flucytosine is converted inside the fungal cell to 5-FU → 5F-dUMP → inhibits thymidylate synthase → ↓ DNA synthesis. Synergistic with amphotericin B (increases cell permeability → more drug enters)."},
  {id:"final33",exam:"final",lecture:"Antifungal Drugs",q:"What is the mechanism of action of miconazole (and other azoles)?",options:["Binds ergosterol forming pores in the fungal cell membrane","Inhibits lanosterol conversion to ergosterol via CYP14α-demethylase","Inhibits squalene epoxidase causing squalene accumulation","Inhibits beta-glucan synthase disrupting fungal cell wall"],answer:1,explanation:"Azoles inhibit fungal CYP450-dependent C14-α-demethylase → blocks lanosterol→ergosterol conversion → ergosterol depletion → membrane dysfunction. A = amphotericin B/nystatin; C = terbinafine; D = echinocandins."},
  {id:"final34",exam:"final",lecture:"Antifungal Drugs",q:"An HIV patient developed systemic candidiasis. An antifungal was given IV but later caused elevated liver enzymes. Which drug was most likely given?",options:["Ketoconazole","Flucytosine","Fluconazole","Caspofungin"],answer:0,explanation:"Ketoconazole frequently causes hepatotoxicity and also inhibits adrenal/gonadal steroid synthesis. It is rarely used systemically due to its toxicity profile — fluconazole is preferred for most fungal infections."},
  {id:"final35",exam:"final",lecture:"Antifungal Drugs",q:"Which of the following antifungal drugs is a polyene?",options:["Amphotericin B","Ketoconazole","Caspofungin","Terbinafine"],answer:0,explanation:"Polyenes (amphotericin B, nystatin) bind ergosterol in the fungal cell membrane → form pores → leakage of ions → cell death. Ketoconazole is an azole; caspofungin is an echinocandin; terbinafine is an allylamine."},
  ...
  {id:"final39",exam:"final",lecture:"Antifungal Drugs",q:"A patient is given both fluconazole and warfarin simultaneously. What will most likely result?",options:["Bleeding due to elevated warfarin levels","Decreased antifungal efficacy of fluconazole","Reduced warfarin levels requiring dose increase","No clinically significant interaction occurs"],answer:0,explanation:"Fluconazole inhibits CYP2C9 → decreases warfarin metabolism → elevated warfarin plasma levels → increased anticoagulant effect → bleeding risk. Dose monitoring and adjustment are required."},
  ...
  {id:"final58",exam:"final",lecture:"Antiviral Drugs",q:"A patient with HSV encephalitis — physician advises drinking large amounts of water to avoid adverse effects. Which drug was given?",options:["Acyclovir","Ganciclovir","Valacyclovir","Foscarnet"],answer:0,explanation:"IV acyclovir causes crystalluria and nephrotoxicity if inadequately hydrated. It is the drug of choice for HSV encephalitis. Adequate hydration and slow IV infusion are required to prevent nephrotoxicity."},
  {id:"final59",exam:"final",lecture:"Antiviral Drugs",q:"What is the drug of choice for CMV retinitis?",options:["Ganciclovir","Acyclovir","Ribavirin","Oseltamivir"],answer:0,explanation:"Ganciclovir (IV) or valganciclovir (oral prodrug) is DOC for CMV retinitis. Major adverse effect: myelosuppression. Acyclovir has poor anti-CMV activity. Ribavirin and oseltamivir are not used for CMV."},
  {id:"final60",exam:"final",lecture:"Antiviral Drugs",q:"What is a component of HAART?",options:["Nucleoside reverse transcriptase inhibitor","Aminoglycoside antibiotic","Beta-lactamase inhibitor","Neuraminidase inhibitor"],answer:0,explanation:"HAART = typically 2 NRTIs + 1 NNRTI or protease inhibitor. This multidrug combination suppresses viral replication at multiple steps and prevents resistance. The other options are unrelated to HIV treatment."},
  {id:"final61",exam:"final",lecture:"Antiviral Drugs",q:"A patient's physician added ritonavir to the drug regimen. Why?",options:["Ritonavir provides synergistic antiviral activity","Ritonavir provides additive antiviral activity","Ritonavir is a CYP3A4 inhibitor used as a pharmacokinetic booster","Ritonavir provides coverage against resistant HIV strains"],answer:2,explanation:"Low-dose ritonavir inhibits CYP3A4 → reduces metabolism of co-administered protease inhibitors → higher and more sustained plasma levels of the \"boosted\" PI. This is pharmacokinetic enhancement, not antiviral synergy."},
  {id:"final62",exam:"final",lecture:"Antiviral Drugs",q:"Which antiviral drug is contraindicated in pregnant women?",options:["Ribavirin","Lamivudine","Zidovudine","Acyclovir"],answer:0,explanation:"Ribavirin is Category X — teratogenic and mutagenic. Contraindicated in pregnancy and requires two forms of contraception. Also causes dose-dependent hemolytic anemia. Lamivudine, zidovudine, and acyclovir are safe/acceptable in pregnancy."},
  {id:"final63",exam:"final",lecture:"Antiviral Drugs",q:"A 60-year-old man with Parkinson's disease needs prophylaxis against influenza A. Which mechanism of action is most efficient for this purpose?",options:["Prevents viral replication","Prevents viral uncoating","Prevents release of newly synthesized viruses from host cells","Inhibits viral neuraminidase"],answer:1,explanation:"Amantadine inhibits the M2 protein → prevents viral uncoating and release of viral RNA into host cells. It is uniquely useful here because it also has anti-Parkinson's activity. Active against influenza A only."},
  ...
  {id:"final77",exam:"final",lecture:"Anticancer Drugs (1) — Antimetabolites & Antibiotic Agents",q:"Which of the following anticancer drugs is a tyrosine kinase inhibitor?",options:["Leukotrienes","Ibuprofen","Aspirin","Celecoxib"],answer:1,explanation:"Ibuprofen (and most NSAIDs) reversibly inhibit COX-1/COX-2 → platelet function returns when drug is eliminated. Aspirin irreversibly acetylates platelet COX-1 → effect lasts platelet lifespan (7–10 days). Celecoxib selectively inhibits COX-2 (not platelet COX-1)."},
  ...
  {id:"final79",exam:"final",lecture:"Anticancer Drugs (1) — Antimetabolites & Antibiotic Agents",q:"Prednisone is used in which of the following?",options:["Lymphomas and leukemias","Pulmonary tuberculosis","Cushing syndrome","Peptic ulcer disease"],answer:0,explanation:"Corticosteroids (prednisone) have direct cytotoxic effects on lymphoid cells and are part of chemotherapy regimens for lymphomas (MOPP regimen) and leukemias. They are contraindicated in active TB and worsen peptic ulcers."},
  ...
  {id:"final98",exam:"final",lecture:"Anticancer Drugs (2) — Alkylating Agents, Microtubule Inhibitors, Hormones",q:"Which drug must have its dose reduced by 25% when given with allopurinol?",options:["Mercaptopurine","Mechlorethamine","Methotrexate","Cisplatin"],answer:0,explanation:"Allopurinol inhibits xanthine oxidase → ↓ 6-MP metabolism → accumulation → severe myelosuppression. Dose must be reduced to 25% of normal. The other drugs listed are not metabolized by xanthine oxidase."},
  {id:"final99",exam:"final",lecture:"Anticancer Drugs (2) — Alkylating Agents, Microtubule Inhibitors, Hormones",q:"Doxorubicin cardiotoxicity can be reduced by:",options:["MESNA","Dexrazoxane","Leucovorin","Filgrastim"],answer:1,explanation:"Dexrazoxane (iron chelator) prevents doxorubicin cardiotoxicity by binding free iron that would otherwise participate in free-radical generation in cardiac tissue. MESNA is for cyclophosphamide cystitis; leucovorin is for MTX toxicity; filgrastim is for neutropenia."},
  ...
  {id:"final102",exam:"final",lecture:"Anticancer Drugs (2) — Alkylating Agents, Microtubule Inhibitors, Hormones",q:"First-line treatment for breast cancer caused by a positive estrogen receptor:",options:["Interferons","Tamoxifen","Trastuzumab","Cyclophosphamide"],answer:1,explanation:"Tamoxifen (SERM) competitively blocks estrogen receptors in breast tissue → prevents estrogen-driven cell proliferation. First-line for ER+ breast cancer. Trastuzumab is for HER2+ cancer; interferons and cyclophosphamide are non-targeted therapies."},
  ...
  {id:"final114",exam:"final",lecture:"Mixed/Other",q:"An 8-year-old boy with ADHD on methylphenidate — his brother takes the bottle and develops toxicity. Expected presentation?",options:["Hypertension, tachycardia, and seizures","Miosis, sweating, and diarrhea","Hypotension and coma","Bradycardia, bronchospasm, and urinary incontinence"],answer:0,explanation:"Methylphenidate overdose → excessive CNS stimulation → hypertension, tachycardia, hyperthermia, seizures, psychosis. B describes cholinergic toxidrome; C describes opioid overdose; D describes beta-blocker toxicity."},
  {id:"final115",exam:"final",lecture:"Mixed/Other",q:"To prolong the duration of a drug:",options:["Increase the vascularity of the absorbing area","Reduce the solubility of the drug formulation","Administer the drug in an aqueous solution","Administer the drug with a full meal"],answer:1,explanation:"Reducing drug solubility (depot formulations, oil-based injections, procaine penicillin G, benzathine penicillin G) slows dissolution and absorption → prolongs duration. Increasing vascularity or using aqueous solutions speeds absorption."},
